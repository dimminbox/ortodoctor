...
if(!isset($_POST['Форма'])){ print_js(); }else{
...
if(function_exists('get_field')){
	...
	foreach($mail_profiles as $profile){
		if($profile['form'] == $_POST['Форма']) $form_profile = $profile;
	}
...
if($mail_settings['reply'] && !empty($mail_settings['reply_email'])){
...
var selector = '.w-form form', form_ids = [], cur_id = '';
