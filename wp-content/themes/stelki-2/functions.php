...
function add_site_scripts() {
  ...
  wp_register_script( 'jquery-core', '//ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js',false,false,true);
  wp_enqueue_script( 'jquery' );
  wp_register_script('main_script', get_template_directory_uri().'/js/main.js', array('jquery'),false,true);
  wp_enqueue_script('main_script');
  wp_register_script('modernizr_script', get_template_directory_uri().'/js/modernizr.js', array('jquery'),false,true);
