...
add_action('widgets_init', function(){return register_widget("wplook_contact_widget");});
...
?>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('mobile_phone')); ?>"> <?php _e('Phone:', 'healthmedical-wpl'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('telephone')); ?>"> <?php _e('Fax:', 'healthmedical-wpl'); ?> </label>
	...
	<div class="contacts">
		...
		<ul>
			...
			<?php if ( $telephone ) { ?>
				<li>
					<p>
						<span><?php _e('Fax:', 'healthmedical-wpl'); ?> </span>
