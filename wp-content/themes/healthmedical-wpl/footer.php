	...
	<div class="footer">
		...
		<div class="row">
			<p class="copyright">
				...
				<?php _e('Designed by', 'healthmedical-wpl'); ?> <a href="https://wplook.com/product/themes/non-profit/health-medical-wordpress-theme/?utm_source=Footer-URL&utm_medium=link&utm_campaign=Health-Medical" title="<?php _e('WPlook Studio', 'healthmedical-wpl'); ?>" rel="nofollow" target="_blank"><?php _e('WPlook Studio', 'healthmedical-wpl'); ?></a>
