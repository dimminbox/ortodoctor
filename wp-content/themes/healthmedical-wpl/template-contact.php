...
<?php
	...
	$wpl_contact_map_icon = get_post_meta( $pid, 'wpl_contact_map_icon', true );
?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class( array('event', 'article-single-event') ); ?> itemscope itemtype="https://schema.org/BlogPosting">
							<div class="entry-content">
								<div class="event-body" itemprop="articleBody">
									...
									<?php
										if( $wpl_contact_map == 'on' && !empty( $wpl_contact_map_address ) ) {
											$options = array(
											...
											$maps->generate_map( array(
												'maps_address' => $wpl_contact_map_address,
												'marker' => $wpl_contact_map_icon,
											) );
										}
									?>
