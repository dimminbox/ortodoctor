...
function wpl_meta_boxes() {
	...
	$page_template_meta_box = array(
		...
		'fields'      => array(
			...
			array(
				'label'       => __('Display subtitle', 'medical-toolskit'),
				'id'          => 'wpl_header_subtitle_display',
				'type'        => 'on-off',
				'desc'        => __('If enabled, you will be able to add a subtitle above the name of the page.', 'medical-toolskit'),
				'std'         => 'on',
				'rows'        => '',
				'post_type'   => '',
				'taxonomy'    => '',
			...
			array(
				...
				'class'       => '',
				'section'     => '',
				'condition'   => 'wpl_header_subtitle_display:is(on)'
			),
		)
	);
	...
	if ($post_id) {
		...
		if ($post_template == 'template-doctors.php' || $post_template == 'template-services.php' || $post_template == 'template-testimonials.php' || $post_template == 'template-departments.php' ) {
	...
	$contact_page_meta_box = array(
		...
		'fields'      => array(
			...
			array(
				'label'       => __( 'Event Google Maps Location', 'medical-toolskit' ),
				'id'          => 'wpl_contact_map_address',
				'type'        => 'text',
				'desc'        => sprintf( __( 'Maps are dispayed using <a href="%s">Google Maps</a>, so check your location is displayed correctly there before pasting it in here.<br><br>Remember to include your Google Maps API key on the <a href="%s">Theme Options</a> page for maps to be displayed correctly.', 'medical-toolskit' ), 'https://maps.google.com', admin_url( 'themes.php?page=ot-theme-options' ) ),
				'std'         => '',
				'rows'        => '',
				'post_type'   => '',
				'taxonomy'    => '',
			...
			array(
				'label'       => __( 'Pin Map Icon', 'medical-toolskit' ),
				'id'          => 'wpl_contact_map_icon',
				'type'        => 'upload',
				'desc'        => __( 'Upload an image of a pin for the map. Recommended image size: ~32x32px.', 'medical-toolskit' ),
				'std'         => '',
				'rows'        => '',
				'post_type'   => '',
				'taxonomy'    => '',
	...
	/*-----------------------------------------------------------
  		Meta box for single departments
  	-----------------------------------------------------------*/

	$departments_meta_box = array(
		'id'          => 'departments_meta_box',
		'title'       => __('Post/Page Options', 'medical-toolskit'),
		'desc'        => '',
		'pages'       => array( WPL_TOOLSKIT_SLUG_SHORT . 'post_departments' ),
		'context'     => 'normal',
		'priority'    => 'high',
		'fields'      => array(
			array(
	...
	ot_register_meta_box( $departments_meta_box );
}
